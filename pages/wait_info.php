...
<br><br>
<center>
<img src="animasjoner/ventegif_transparent.gif" height="400px" alt"Venter på resten av laget..."> <!-- Gif som ber bruker å vente på resten av laget -->
</center>
...
if ($stepid == "3") {
	mysql_query("UPDATE users SET done1='0', done2='0', done4='0', done5='0', done6='0'  WHERE id='$uid'") 
	or die(mysql_error()); 
} elseif ($stepid == "1") {
